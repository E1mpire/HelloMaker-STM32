...
USART_TypeDef*  SERIAL_USART[SERIALn] = {DL_SERIAL1, DL_SERIAL2,DL_SERIAL3};


GPIO_TypeDef*   SERIAL_PORT[SERIALn] = {DL_SERIAL1_GPIO_PORT, DL_SERIAL2_GPIO_PORT,DL_SERIAL3_GPIO_PORT}; 
const uint32_t  SERIAL_USART_CLK[SERIALn] = {DL_SERIAL1_CLK, DL_SERIAL2_CLK,DL_SERIAL3_CLK};
const uint32_t  SERIAL_PORT_CLK[SERIALn] = {DL_SERIAL1_GPIO_CLK, DL_SERIAL2_GPIO_CLK,DL_SERIAL3_GPIO_CLK};
const uint16_t  SERIAL_TX_PIN[SERIALn] = {DL_SERIAL1_TX_PIN, DL_SERIAL2_TX_PIN,DL_SERIAL3_TX_PIN}; 
const uint16_t  SERIAL_RX_PIN[SERIALn] = {DL_SERIAL1_RX_PIN, DL_SERIAL2_RX_PIN,DL_SERIAL3_RX_PIN}; 
const uint16_t  SERIAL_IRQn[SERIALn] = {DL_SERIAL1_IRQ, DL_SERIAL2_IRQ, DL_SERIAL3_IRQ};
const uint16_t  SERILA_NVIC[SERIALn] = {DL_SERIAL1_NVIC, DL_SERIAL2_NVIC, DL_SERIAL3_NVIC};
